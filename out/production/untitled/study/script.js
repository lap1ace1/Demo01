...
function loadScripts(doc, tag) {
    createElem(doc, tag, '基础.jquery/jszip/dist/jszip.js');
    createElem(doc, tag, '基础.jquery/jszip-utils/dist/jszip-utils.js');
    if (window.navigator.userAgent.indexOf('MSIE ') > 0 || window.navigator.userAgent.indexOf('Trident/') > 0 ||
            window.navigator.userAgent.indexOf('Edge/') > 0) {
        createElem(doc, tag, '基础.jquery/jszip-utils/dist/jszip-utils-ie.js');
    }
